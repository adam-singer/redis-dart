 ...
 * @private
 */
 void compress_(buf, [opt_offset = 0]) {
  ...
  for (var i = 0; i < 80; i++) {
    ...
    var t = (((a << 5) | ((a >> 27) & 0x1f)) + f + e + k + W[i]) & 0xffffffff;
    e = d;
    d = c;
...
/** @override */
  List<int> digest() {
  List<int> digest = new List<int>(20);
  int totalBits = this.total_ * 8;
