...
_loggerBuilder(name) {
  if(name == "Verbose"){
    ...
    return new LoggerImpl(name, debugEnabled: true, errorEnabled:true, infoEnabled:true, warnEnabled:true,appenders:[new FileAppender("log.txt"), new ConsoleAppender()]); 
  }         
